...
About the Players Sofascore Score dataset - 23/24
...
About the Premier League Players 22/23 Dataset

This dataset contains detailed data on all footballers from the 2022/23 premier league season - [Kaggle Premier League 22/23 Dataset](https://www.kaggle.com/datasets/daniwijanarko/premier-league-22-23-stats)
...
About the Players Sofascore Score dataset - 22/23

This dataset contains Team, Player and SofascoreScore data, used to merge with the other dataset - [Sofascore Premier League 22/23 Datas](https://www.sofascore.com/pt/torneio/futebol/england/premier-league/17#id:41886)
...
| Player                         | String  | The name of the player.                                                |
| Rating                         | Float   | The player's Sofascore Score, based on the 23/24 Premier League season.|
